...
export const COA_SEED: CoaSeedAccount[] = [
    ...
    // TK chi tiết theo pháp nhân SÀN TMĐT — autoJournal hạch toán đơn online vào đây
    { code: '131-SHOPEE', name: 'Phải thu Công ty Shopee', nameEn: 'Receivable - Shopee', level: 2, parentCode: '131', type: 'Asset', nature: 'Debit', description: 'Phải thu tiền hàng bán qua sàn Shopee (chờ sàn quyết toán escrow)' },
    { code: '131-TIKTOK', name: 'Phải thu Công ty TikTok', nameEn: 'Receivable - TikTok Shop', level: 2, parentCode: '131', type: 'Asset', nature: 'Debit', description: 'Phải thu tiền hàng bán qua TikTok Shop (chờ sàn quyết toán)' },
    { code: '131-LAZADA', name: 'Phải thu Công ty Lazada', nameEn: 'Receivable - Lazada', level: 2, parentCode: '131', type: 'Asset', nature: 'Debit', description: 'Phải thu tiền hàng bán qua sàn Lazada' },
    { code: '131-SAN', name: 'Phải thu sàn TMĐT khác', nameEn: 'Receivable - other marketplaces', level: 2, parentCode: '131', type: 'Asset', nature: 'Debit' },
    ...
    { code: '3361', name: 'Phải trả nội bộ về vốn kinh doanh', nameEn: 'Intra-company payables - working capital', level: 2, parentCode: '336', type: 'Liability', nature: 'Credit' },
    { code: '3362', name: 'Phải trả nội bộ về chênh lệch tỷ giá', nameEn: 'Intra-company payables - FX differences', level: 2, parentCode: '336', type: 'Liability', nature: 'Credit' },
    { code: '3363', name: 'Phải trả nội bộ về chi phí đi vay đủ điều kiện vốn hóa', nameEn: 'Intra-company payables - capitalizable borrowing costs', level: 2, parentCode: '336', type: 'Liability', nature: 'Credit' },
    { code: '3368', name: 'Phải trả nội bộ khác', nameEn: 'Other intra-company payables', level: 2, parentCode: '336', type: 'Liability', nature: 'Credit' },
    ...
    { code: '34311', name: 'Mệnh giá trái phiếu', nameEn: 'Bond face value', level: 3, parentCode: '3431', type: 'Liability', nature: 'Credit' },
    { code: '34312', name: 'Chiết khấu trái phiếu', nameEn: 'Bond discount', level: 3, parentCode: '3431', type: 'Liability', nature: 'Debit' },
    { code: '34313', name: 'Phụ trội trái phiếu', nameEn: 'Bond premium', level: 3, parentCode: '3431', type: 'Liability', nature: 'Credit' },
    ...
    { code: '41111', name: 'Cổ phiếu phổ thông có quyền biểu quyết', nameEn: 'Ordinary voting shares', level: 3, parentCode: '4111', type: 'Equity', nature: 'Credit' },
    { code: '41112', name: 'Cổ phiếu ưu đãi', nameEn: 'Preference shares', level: 3, parentCode: '4111', type: 'Equity', nature: 'Credit' },
    ...
    { code: '6231', name: 'Chi phí nhân công', nameEn: 'Machinery labor costs', level: 2, parentCode: '623', type: 'Expense', nature: 'Debit' },
    { code: '6232', name: 'Chi phí vật liệu', nameEn: 'Machinery materials costs', level: 2, parentCode: '623', type: 'Expense', nature: 'Debit' },
    { code: '6233', name: 'Chi phí dụng cụ sản xuất', nameEn: 'Machinery tools costs', level: 2, parentCode: '623', type: 'Expense', nature: 'Debit' },
    { code: '6234', name: 'Chi phí khấu hao máy thi công', nameEn: 'Machinery depreciation', level: 2, parentCode: '623', type: 'Expense', nature: 'Debit' },
    { code: '6237', name: 'Chi phí dịch vụ mua ngoài', nameEn: 'Outsourced services - machinery', level: 2, parentCode: '623', type: 'Expense', nature: 'Debit' },
    { code: '6238', name: 'Chi phí bằng tiền khác', nameEn: 'Other cash costs - machinery', level: 2, parentCode: '623', type: 'Expense', nature: 'Debit' },
